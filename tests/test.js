const DataParser = require("./dist/logzioBlobAzureFunction/data-parser");
const logsBuilder = require("./tests/log-builder-test");
const logHandler = require("./dist/logzioBlobAzureFunction/core");
